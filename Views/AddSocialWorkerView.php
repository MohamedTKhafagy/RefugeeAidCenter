...
<head>
    <meta charset="UTF-8">
    <title>Add New Social Worker</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
</head>
<body>
<div class="container">
    <h2 class="mt-4 mb-4">Add New Social Worker</h2>
    <?php $base_url = rtrim(dirname($_SERVER['SCRIPT_NAME']), '/'); ?>
    <form action="<?php echo $base_url; ?>/socialWorkers/add" method="POST">
        <!-- Hidden action field -->
        ...
        <div class="form-group">
            ...
            <input readonly type="text" name="Type" id="Type" value="Social Worker" class="form-control" required>
        </div>
        ...
        <button type="submit" class="btn btn-primary">Add SocialWorker</button>
