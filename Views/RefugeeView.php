    ...
    <table class="table table-bordered">
        ...
        <tbody>
            <?php foreach ($refugees as $refugee): ?>
                <tr>
                    <td><?php echo htmlspecialchars($refugee->getID()); ?></td>
                    <td><?php echo htmlspecialchars($refugee->getName()); ?></td>
                    <td><?php echo htmlspecialchars($refugee->getGender()); ?></td>
                    <td><?php echo htmlspecialchars($refugee->getAge()); ?></td>
                    <td><?php echo htmlspecialchars($refugee->getNationality()); ?></td>
                    <td>
                        <a href="update_refugee.php?id=<?php echo $refugee->getID(); ?>" class="btn btn-warning btn-sm">Update</a>
                        <a href="delete_refugee.php?id=<?php echo $refugee->getID(); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this refugee?');">Delete</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
